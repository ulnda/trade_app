...
%% Our client has decided to accept the transaction
%% Make the other FSM aware of it and move to negotiate state.
idle_wait(accept_negotiate, _From, S = #state{ other = OtherPid }) -> 
	accept_negotiate(OtherPid, self()),
	notice(S, "acception negotiation", []),
...
%% and we add the 'from' to the state so we can reply 
%% to the user once ready
...
%% The other clients was waiting for us! Let's reply to ours and
...
%% but for our purposes, outputting to the sell is enough.
